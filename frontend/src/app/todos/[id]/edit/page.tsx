      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <span className="text-gray-600">Loading todo...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
          ...
          <div className="mt-6">
            <button
              onClick={() => router.back()}
              className="px-5 py-3 bg-indigo-600 text-white rounded-lg shadow-md hover:bg-indigo-700 transition-colors flex items-center"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-50 transition-all"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="completed" className="flex items-center">
                ...
                />
                <span className="ml-3 text-sm font-medium text-gray-700">Completed</span>
              </label>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between gap-3 pt-4">
            <button
              ...
              onClick={() => router.back()}
              disabled={loading}
              className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg shadow-sm hover:bg-gray-50 disabled:opacity-50 transition-colors flex items-center justify-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-indigo-600 text-white rounded-lg shadow-md hover:bg-indigo-700 disabled:opacity-50 transition-colors flex items-center justify-center min-w-[120px]"
            >
              {loading ? (
                <>
