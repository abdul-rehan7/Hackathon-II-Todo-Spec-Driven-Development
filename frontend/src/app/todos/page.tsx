      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card p-6">
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <span className="text-gray-400">Loading todos...</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="card p-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
          ...
          <Link
            href="/todos/add"
            className="btn-primary px-5 py-3 rounded-lg shadow-md transition-colors flex items-center justify-center"
          >
        ...
        {todos.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 text-lg mb-6">No todos found. Add a new one to get started!</p>
            <Link
              href="/todos/add"
              className="btn-primary px-6 py-3 rounded-lg shadow-md transition-colors inline-flex items-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            ...
            <div className="hidden md:block card overflow-hidden">
              <table className="min-w-full divide-y divide-gray-700">
                <thead className="bg-gray-800">
                  <tr>
                    <th scope="col" className="py-4 px-6 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                      Title
                    </th>
                    <th scope="col" className="py-4 px-6 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                      Status
                    ...
                    <th scope="col" className="py-4 px-6 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-700">
                  {todos.map((todo) => (
                    <tr key={todo.id} className="hover:bg-gray-800/50">
                      ...
                      <td className="py-4 px-6 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-3">
                          <Link
                            ...
                            className="text-indigo-400 hover:text-indigo-300 p-2 rounded-full hover:bg-gray-700/50 transition-colors"
                            title="Edit todo"
                          >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center mb-2">
                        <h3 className={`font-medium truncate ${todo.completed ? 'line-through text-gray-500' : 'text-white'}`}>
                          {todo.title}
                        </h3>
                      </div>
